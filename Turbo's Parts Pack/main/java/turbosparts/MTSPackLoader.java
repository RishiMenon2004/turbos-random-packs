...
public class MTSPackLoader{
	...
	public static final String MODID="turbosparts";
	//Short title for your pack.
	public static final String MODNAME="Turbo Defender's Parts Pack";
	...
	public static final String DEPS="required-after:mts@[15.0.0,);required-after:mtsofficialpack@[13.0.0,);required-after:turbosfoodtruckselections@[1.0.0]";
